export const books = [
  {
    ...
    text: `Shoes take a beating. They get wet, dirty and scuffed. Soles wear down. Laces break.
      ...
      But while the technology for breaking down and repurposing shoes is improving, some experts note that recycling old footwear still has some challenges.
...

  {
    ...
    text: `MIAMI, Florida — Shohei Ohtani looked up at the boisterous crowd that turned out to cheer him and the Los Angeles Dodgers — and entertained each and every spectator with one of the greatest individual performances and seasons in major league history.
      ...
      Ohtani raced past the 50-50 milestone in the most spectacular game of his history-making career, becoming the first big league player to hit three homers and steal two bases in a game during a 20-4 rout of the Miami Marlins on September 19 that also secured a playoff spot for the Dodgers.
      ...
      He finished a triple shy of the cycle on September 19, adding a run-scoring single and two doubles. He was thrown out at third base while trying to stretch his second double into a triple.
